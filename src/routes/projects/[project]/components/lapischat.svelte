  ...
  <div class="pl-4 pt-4">
    ...
    <div class="pl-4 py-4 text-lg">
      ...
      <p class="pr-50">
        ...
        all data is discarded — no history, no storage, no surveillance.
      </p>
    </div>
