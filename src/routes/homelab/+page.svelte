...
<div class="mt-3 w-[84vw] mb-20">
  ...
  <p class="px-5 pt-3 text-lg pr-50 pl-8 pt-10">
    ...
    <br /><br />
    At the start of June 2025, I finally got the chance to start my homelab journey,
    from reading/seeing people online work on their machines doing all sort of stuff,
    I was very excited to get started and understand the world of Computers even
    more.
    <br /><br />
    Specifications:- <br />
  </p>
  <ol class="list-disc pl-16 pt-4">
    <li>
      <span class="font-bold">Processor</span>: AMD Ryzen 5 3400G {`{4C/4T}`}
    </li>
    <li>
      <span class="font-bold">MotherBoard</span>: Gigabyte A520M K v2 {`{AM4}`}
    </li>
    <li><span class="font-bold">RAM</span>: 16GB DDR4 3000MHz</li>
    <li>
