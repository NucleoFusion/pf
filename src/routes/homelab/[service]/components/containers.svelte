...
<div class="mt-3 w-[84vw] mb-20">
  ...
  <p class="px-5 pt-3 text-lg pr-50 pl-8 pt-10">
    ...
    website, along with others, will hopefully be properl hosted. (Well, if you
    are seeing this, it probably is).
    <br />
    <br />
    Current Plans include hosting:- <br />
  </p>
  <ol class="list-disc pl-16 pt-4">
    <li>Portfolio</li>
    <li>D2D</li>
    <li>LapisOAuth</li>
    <li>My SMTP Mailer</li>
    <li>and more...</li>
  </ol>
</div>
